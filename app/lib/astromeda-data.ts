...
export const COLLABS: CollabItem[] = [
  ...
  { id: 'naruto', name: 'NARUTO-ナルト- 疾風伝', tag: 'NEW', accent: '#F4811F', pt: 'spiral', desc: '全5種×3ティア＋マウスパッド＋キーボード。', cats: 'pc,pad,kb', f: 1, shop: 'naruto-shippuden' },
  ...
  { id: 'sf6', name: 'ストリートファイター6', tag: '', accent: '#D84315', pt: 'burst', desc: 'ジュリ・リュウ・キャミィ・豪鬼・ケン。8ティア¥157,530〜¥565,800。', cats: 'pc,panel,pad', f: 1, shop: 'streetfighter-collaboration' },
  { id: 'sanrio', name: 'サンリオキャラクターズ', tag: 'NEW', accent: '#FF69B4', pt: 'wave', desc: 'ハローキティ他4キャラ。PC5ティア¥178,800〜¥413,829。', cats: 'pc,pad,kb,case,acrylic', f: 1, shop: 'sanrio-characters-collaboration' },
  { id: 'sonic', name: 'ソニック・ザ・ヘッジホッグ', tag: '', accent: '#0066FF', pt: 'sphere', desc: 'ソニック＆シャドウ 2デザイン×3ティア＋マウスパッド。', cats: 'pc,pad', f: 1, shop: 'sega-sonic-astromeda-collaboration' },
  { id: 'jujutsu', name: '呪術廻戦', tag: 'HOT', accent: '#7B2FBE', pt: 'curse', desc: 'パッド＋パネル＋KB＋アクスタ＋缶バッジ＋メタルカード。', cats: 'pad,panel,kb,acrylic,badge,goods', f: 1, shop: 'jujutsukaisen-collaboration' },
  { id: 'chainsawman', name: 'チェンソーマン レゼ篇', tag: 'HOT', accent: '#C62828', pt: 'burst', desc: '劇場版コラボPC3ティア＋マウスパッド。', cats: 'pc,pad', f: 1, shop: 'chainsawman-movie-reze' },
  ...
  { id: 'bleach-tybw', name: 'BLEACH 千年血戦篇', tag: '', accent: '#8B8B8B', pt: 'cross', desc: '一護・ルキア・白哉・日番谷 着せ替えパネル4面¥20,800。', cats: 'panel', f: 0, shop: 'bleach-anime-astromeda-collaboration' },
  { id: 'geass', name: 'コードギアス 反逆のルルーシュ', tag: '', accent: '#9C27B0', pt: 'prism', desc: 'ルルーシュ＆スザク。PC6モデル・マウスパッド・PCケース。', cats: 'pc,pad,case', f: 0, shop: 'geass-collaboration' },
  ...
  { id: 'sao', name: 'ソードアート・オンライン', tag: '', accent: '#2196F3', pt: 'prism', desc: 'SAOコラボPC。', cats: 'pc', f: 0, shop: 'swordart-online-collaboration' },
  ...
  { id: 'pacmas', name: 'アイ MAKE IMP@CT！', tag: '', accent: '#FF4081', pt: 'sphere', desc: '14種コラボPC＋マウスパッド＋着せ替えパネル。', cats: 'pc,pad,panel', f: 0, shop: 'pacmas-astromeda-collaboration' },
  { id: 'sumikko', name: 'すみっコぐらし', tag: 'NEW', accent: '#A8D8B9', pt: 'wave', desc: 'やさしい色合いのゲーミングPC・マウスパッド・グッズ。', cats: 'pc,pad,goods', f: 0, shop: 'sumikko' },
  { id: 'rilakkuma', name: 'リラックマ', tag: '', accent: '#D4A574', pt: 'wave', desc: '癒しカラーのゲーミングPC・マウスパッド・グッズ。', cats: 'pc,pad,goods', f: 0, shop: 'rirakkuma' },
  { id: 'garupan', name: 'ガールズ＆パンツァー', tag: '', accent: '#795548', pt: 'sphere', desc: 'PC＋パッド＋パネル＋Tシャツ＋アクスタ＋アクキー。', cats: 'pc,pad,panel,tshirt,acrylic', f: 0, shop: 'girls-und-panzer-collaboration' },
  { id: 'nitowai', name: '新兎わい', tag: '', accent: '#E91E63', pt: 'wave', desc: 'VTuberコラボPC＋マウスパッド＋アクリルスタンド。', cats: 'pc,pad,acrylic', f: 0, shop: 'pc-nitowai' },
  { id: 'palworld', name: 'Palworld（パルワールド）', tag: '', accent: '#26C6DA', pt: 'sphere', desc: 'パルデザイン6モデルPC。', cats: 'pc', f: 0, shop: 'astromeda-palworld-collaboration-pc' },
  { id: 'imas-ml', name: 'アイドルマスター ミリオンライブ！', tag: '', accent: '#FFEB3B', pt: 'straw', desc: '39キャラ個別PC・マウスパッド・マウス・アクキー・パネル。', cats: 'pc,pad,panel,mouse,acrylic', f: 0, shop: 'idolmaster' },
  { id: 'milpr', name: 'ミリプロ', tag: '', accent: '#00BCD4', pt: 'prism', desc: '音ノ乃のの・甘狼このみ他。PC・マウスパッド・パネル。', cats: 'pc,pad,panel,acrylic', f: 0, shop: 'milpr-pc' },
];
