...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    detail: [
      ...
      'ステータスを「🟢 公開」にして保存。',
      '商品詳細画面の「種類（色・サイズ）」タブで在庫数や価格を調整できます。',
    ],
    cautions: [
      'PC 商品は「PC」または「ゲーミング」タグが必須（無いとカスタマイズプルダウンが出ない）。',
    ],
    links: [
  ...
  },
  {
    ...
    summary: '「プルダウン管理」タブで、メモリ・SSD 等のプルダウンを編集できる（全商品共通）。',
    detail: [
      '「プルダウン管理」タブを開く。プルダウンが無い場合は「＋新しいプルダウンを作る」から追加。',
      'プルダウンの「ラベル」に「+¥35,000」のように追加金額を書けば、カート合計に自動反映。',
      ...
      <div style={{marginBottom: space[4]}}>
        ...
        >
          ...
          <QuickAction
            emoji="🎛️"
            title="プルダウンを編集"
            detail="SSD容量／マザーボード／キーボード配列などプルダウンを編集"
